	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Ajouter Responsable Media</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Ajouter Responsable Media</h1>
			</div>
		</div><!--/.row-->
...
{		
			...
			$ajout=$med->ajouter_media($nom,$prenom,$login,$pass);
			
			if($ajout)
			{
					$link='liste_media.php?message=add';
					$user->location($link);
			}
		}}
	?>	
