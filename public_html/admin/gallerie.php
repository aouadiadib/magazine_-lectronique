...
<body>
  ...
  <nav>
			<table>
                ...
                <tr>
					<td class="color2"><a href="ajout_img.php"><font color="white">Ajouter Image</font></a></td>
				</tr> 
				</table></nav>
  <br><br><br>
                    ...
                    while($donnees=mysql_fetch_array($result)){
                       ...
                       $img=$donnees["img"];
						...
						<tr>
							...
							<td>
			<img src="../images/<?php echo $img; ?>" width="250" height="150">		
								</td>
                           <td>
								<?php  echo $titre;?>
							</td>
								...
								<td><center>
				<?php echo "<a href='del_img.php?d=$id_gal'>"; 
