...
public function liste_photo()
	{
		
		$select = DataBase::connect()->query("select * from photo  ORDER BY id_pic DESC LIMIT 4");
		$liste = $select->fetchAll(PDO::FETCH_ASSOC);
		return $liste;
		
	}

public function liste_all_photo()
	{
		
		$select = DataBase::connect()->query("select * from photo  ORDER BY id_pic DESC ");
		$liste = $select->fetchAll(PDO::FETCH_ASSOC);
		return $liste;
	...
	public function liste_pub()
	{
		...
		$select = DataBase::connect()->query("select * from pub  ORDER BY id_pub DESC LIMIT 1");
		$liste = $select->fetchAll(PDO::FETCH_ASSOC);
		return $liste;
...
try {		
	...
	{
		$select = DataBase::connect()->query("select * from video  ORDER BY id_video DESC LIMIT 5");
		$liste = $select->fetchAll(PDO::FETCH_ASSOC);
		return $liste;
	}
